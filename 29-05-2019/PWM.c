...
void main() {
  ...
  // CCP peripheral setting as PWM
  CCP5CON = 0b00001100;
  PR2 = 170; // PERCHÉ È ASSOCIATO AL TIMER E NON AL CCP?
  CCPTMRS1 = 0;

  // pwm preset
  CCPR5L = 64; // target timing: 0-> 0 duty 255-> 100% duty

  // CCP peripheral settings as capture unit
  ...
  while(1){
    ...
    if(millimeters > 1000){
      CCPR5L = 0;
    } else if(millimeters < 320){
      CCPR5L = 0;
    } else {
      CCPR5L = (1000 - (millimeters%1000))>>2;
    }
